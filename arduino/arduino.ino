...
void loop() { 
  ...
  // inductive sensor detects a can and it is lightweight
    ...
    openServo2();
    openServo4();
    displayScreen("Light Can Detected"\t "Accepted");
    current_command = -1; 
  } 
  // inductive detects a can but it is heavy
    ...
    openServo2();
    openServo3();
    displayScreen("Heavy Can Detected"\t "Rejected");
    current_command = -1; 
  } 
  ...
  // inductive did not detect a can and also it is heavy
    ...
    openServo2();
    openServo3();
    displayScreen("Unknown Heavy Object" \t "Rejected");
    current_command = -1; 
  } 
  // IR break beam detects a plastic bottle
    ...
    openServo4();
    openServo5();
    displayScreen("Plastic Bottle Detected" \t "Accepted");
    current_command = -1; 
  } 
  // IR break beam did not detect a plastic bottle
  else if (current_command == 8) { 
    openServo3();
    displayScreen("Non-Bottle Object" \t "Rejected");
    current_command = -1; 
  } 
/*
